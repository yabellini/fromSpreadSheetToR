...
In each section we include exercises and challenges along with examples. We make use various data sets for the problems we want to solve. We want these data to be realistic so that anyone can find similarities in their own data and can apply what they have learned to other situations.

### Before we start

During this workshop we will use R and RStudio. Please [follow these instructions to prepare for the workshop](prepare.html).
